...
- `STUDENT` tìm môn học theo `subject code`
- `STUDENT` xem syllabus public
- `STUDENT` chat hỏi đáp trong phạm vi đúng `1 môn học`
...
| `LECTURER` | Quản syllabus và document |
| `STUDENT` | Search, xem syllabus, chat |
| `SYSTEM` | Đồng bộ AnythingLLM và xử lý chat |
